...
Game_logic::Game_logic():
    ...
    is_created   (video::Video_subsystem::initialize_subsystem(width , height , fullscreen)&&video::Camera::initialize(width , height , 0 , 0)),
    ...
    gaming_mode  (&main_config)
{
    ...
    if(fullscreen)
    {
        ...
        video::Camera::set_position(location);
    }
}
